...
public class AddRacerGUI {
    ...
    private static void checkEmptyInputs() throws EmptyAddInputException {
        if(inputNameField.getText().equals("Имя гонщика") | inputAgeField.getText().equals("Возраст") | inputTeamField.getText().equals("Команда") | inputPointField.getText().equals("Очки"))   throw new EmptyAddInputException();
    }
    ...
    private static class AddEventListener implements ActionListener {
        ...
        public void actionPerformed (ActionEvent e) {
            try {
                checkEmptyInputs();
                Racer racer = new Racer(inputNameField.getText(), Integer.parseInt(inputAgeField.getText()), inputTeamField.getText(), Integer.parseInt(inputPointField.getText()));
                MainRacerGUI.setRacerWindowEnable(true);
                MainRacerGUI.addRacer(racer);
            } catch (EmptyAddInputException exception) {
                JOptionPane.showMessageDialog(null, exception.getMessage(), "Add Error Alert", JOptionPane.PLAIN_MESSAGE);
            }
        }
    }
    public static class RacerInputFocusListener implements FocusListener {
        ...
        public void focusGained (FocusEvent e) {
            if(inputNameField.getText().equals("Имя гонщика"))    MainRacerGUI.setInput(inputNameField, "");
        }

        public void focusLost (FocusEvent e) {
            if(inputNameField.getText().equals(""))    MainRacerGUI.setInput(inputNameField, "Имя гонщика");
        }
    ...
    public static class TeamInputFocusListener implements FocusListener {
        ...
        public void focusGained (FocusEvent e) {
            if(inputTeamField.getText().equals("Команда"))     MainRacerGUI.setInput(inputTeamField, "");
        }

        public void focusLost (FocusEvent e) {
            if(inputTeamField.getText().equals(""))     MainRacerGUI.setInput(inputTeamField, "Команда");
        }
    ...
    private static class AgeInputFocusListener implements FocusListener {
        ...
        public void focusGained (FocusEvent e) {
            if(inputAgeField.getText().equals("Возраст"))    MainRacerGUI.setInput(inputAgeField, "");
        }

        public void focusLost (FocusEvent e) {
            if(inputAgeField.getText().equals(""))    MainRacerGUI.setInput(inputAgeField, "Возраст");
        }
    }
    ...
    private static class PointInputFocusListener implements FocusListener {
        ...
        public void focusGained (FocusEvent e) {
            if(inputPointField.getText().equals("Очки"))    MainRacerGUI.setInput(inputPointField, "");
        }

        public void focusLost (FocusEvent e) {
            if(inputPointField.getText().equals(""))    MainRacerGUI.setInput(inputPointField, "Очки");
        }
    }
}
